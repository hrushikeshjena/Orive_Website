        ...
        <div className="tes-m-ri">
          ...
          <div className="dir-m-ri">
            ...
            <p>
              ...
              supply chain optimization – all customized for the rice milling
              process.
            </p>
          </div>
          ...
          <div className="button-get-r" type="button">
            <button>
              {" "}
              Get Started
              <img src={Arrow} className="arrow-top-r" />
            </button>
          </div>
        </div>
        ...
        <div className="feat-s">
          ...
          <div className="card-e">
            <div className="back-e">
             ...
             <div className="he"><h4>INVENTORY</h4></div> 
              <p>
                Generate your inventory with your own unit like Bags, K.G.
                Quintal. Also, check the different reports of your stock in one
                place.
              </p>
            </div>
            <div>
              <img src={Grp7} alt=""></img> <div className="hea"> <h4>INVOICING</h4></div>
              <div className="hea-p"><p>
                With Invento, you can create, email, SMS, PDF download or print
                out professional invoices for your customer.
              </p></div> 
            </div>
            <div>
            ...
            <div>
              <img src={Grp9} alt=""></img> <div className="headt"><h4>GST READY</h4></div>
              <div className="head-p">  <p>
                Generate your GST reports automatically like GSR1, GSTR2, GSTR3,
                GSTR2 completely and check with inbuilt self-audit Tool and
                upload.
              </p></div>
            </div>
          </div>
      ...
      <div className="res-erp-ri">
        ...
        <div className="ipad-para">
            <p>
              ...
              Experience real-time inventory tracking, efficient procurement,
              and automated reporting. Enhance productivity with modules
              tailored for rice mills. Empower your business with Annam - where
